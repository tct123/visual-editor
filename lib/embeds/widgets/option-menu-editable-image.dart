...
class OptionMenuEditableImage extends StatelessWidget {
  ...
  final ContentSizeM imageContentSize;
  final Widget child;

  OptionMenuEditableImage({
    required this.controller,
    required this.imageContentSize,
    required this.child,
    Key? key,
  }) : super(key: key);
            ...
            builder: (context) {
              ...
              return ImageResizer(
                onImageResize: (width, height) {
                  final res = _embedUtils.getEmbedNode(
                    controller,
                ...
                imageWidth: imageContentSize.width,
                imageHeight: imageContentSize.height,
